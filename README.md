# DIWA Research Project

**Author:** Robel Sahilu Bekele  
**Contact:** robel.bekele@oulu.fi
**Organization:** University of Oulu
**Website:** https://github.com/robisha-vice/robisha-vice

## Project Overview
Sanitation as a source of Concerns of Emerging Contaminants (CECs)
...
Robel Sahilu Bekele (2026).
*DIWA Research Project* (Version 0.1.0).
University of Oulu.
DOI: 
...
```bibtex
@software robisha-vice,
  author = Robel Sahilu Bekele,
  title = DIWA Research Project,
  year = 2026,
  version = 0.1.0,
  doi = ,
  url = https://github.com/robisha-vice/robisha-vice
}
```
or
